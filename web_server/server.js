...
const serverFile = async (filePath, contentType, response) => {
  try {
    ...
    console.log(err)
    myEmiiter.emit('log', `${err.name}: ${err.message}`, 'errLog.txt')
...
const server = http.createServer((req, res) => {
  ...
  myEmiiter.emit('log', `${req.url}\t${req.method}`, 'reqLog.txt')
  ...
  let filePath = 
    ...
    // hacer la extension .html no obligatorio en el navegador
